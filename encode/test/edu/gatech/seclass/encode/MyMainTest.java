...
public class MyMainTest {
    ...
    */
    ...
    public void encodeTest16() throws Exception {
        ...
        assertEquals("-n value must be greater than or equal to 0 or less than or equal to 25", errStream.toString().trim());
    }
    ...
    public void encodeTest17() throws Exception {
        ...
        assertEquals("-l flag value must be an integer greater than or equal to 1", errStream.toString().trim());
    }
